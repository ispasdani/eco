...
import styles from "@/components/countries/styles.module.scss";
...
const Countries = () => {
  ...
  return (
    <div className={styles.countries}>
      <svg viewBox="0 0 75 34" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="Group 12">
          <path
            className={styles.HU}
            ...
            onMouseEnter={handlePathHover(setShowHu)}
            onMouseLeave={handlePathLeave(setShowHu)}
          />
          <path
            id="MD"
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            onMouseEnter={handlePathHover(setShowMd)}
            onMouseLeave={handlePathLeave(setShowMd)}
          />
          <path
            id="RO"
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            onMouseEnter={handlePathHover(setShowRo)}
            onMouseLeave={handlePathLeave(setShowRo)}
          />
        </g>
      </svg>
